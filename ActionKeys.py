'''
# Direct X key mapping for inputs
...
'''
Code copied from https://stackoverflow.com/questions/14489013/simulate-python-keypresses-for-controlling-a-game
'''
...
'''
#Example code for presssing Enter

import ActionKeys

time.sleep(2)
while (True):
    PressKey(ActionKeys.DIK_RETURN)
    time.sleep(3)
    ReleaseKey(ActionKeys.DIK_RETURN)
    time.sleep(3)
'''